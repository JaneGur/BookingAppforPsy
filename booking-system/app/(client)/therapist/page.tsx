...
const therapist = {
    ...
    imageUrl: 'https://i.pravatar.cc/300?u=anna-psy-large',
    contacts: {
        email: 'anna.psy@example.com',
        phone: '+7 (999) 123-45-67',
        vk: 'https://vk.com/annapsy',
        telegram: 'https://t.me/annapsy',
    },
    ...
    about: `Анна — опытный клинический психолог с 10-летним стажем. 
            Специализируется на когнитивно-поведенческой терапии (КПТ), 
            работе с тревожными расстройствами, депрессией и проблемами в отношениях. 
            Ее подход основан на эмпатии, принятии и сотрудничестве.`,
}
